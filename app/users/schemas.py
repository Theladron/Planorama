from pydantic import BaseModel, EmailStr, Field, model_validator, field_validator, Optional
...
class UserUpdate(BaseModel):
    ...
    def check_passwords(cls, data):
        ...
        if (old_password and not new_password) or (new_password and not old_password):
            raise ValueError("Both old_password and new_password must be provided to change password")
