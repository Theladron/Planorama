...
class OpenRouteConnector:
    ...
    def get_location_info(self, town_name: str, lang: str = "en") -> Optional[dict]:
        return openroute.geocode_town(self.client, town_name, lang)

    def get_town_name_by_coords(self, lat: float, lon: float, lang: str = "en") -> Optional[str]:
        return openroute.reverse_geocode_name(self.client, lat, lon, lang)
